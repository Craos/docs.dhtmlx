...
e.attachEvent("onBeforeViewChange",function(o,_,d,s){if(a){a=!1;var l=e._get_url_nav();if(l.event)try{if(e.getEvent(l.event))return setTimeout(function(){t(l.event)}),!1;var c=e.attachEvent("onXLE",function(){setTimeout(function(){t(l.event)}),e.detachEvent(c)})}catch(e){}if(l.date||l.mode){try{this.setCurrentView(l.date?n(l.date):null,l.mode||null)}catch(e){this.setCurrentView(l.date?n(l.date):null,d)}return!1}}var h=["date="+i(s||_),"mode="+(d||o)];r&&h.push("event="+r);var u="#"+h.join(",")
